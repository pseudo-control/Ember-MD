...
def test_forcefield_loading():
    ...
    try:
        ...
        print('  [PASS] ForceField loads: amber19/protein.ff19SB.xml + amber/opc_standard.xml')
        passed += 1
...
def test_water_geometry_after_minimization():
    ...
    """
    print('='*60)
    print('TEST 5: OPC water geometry (rigid constraints, production mode)')
    print('='*60)
...
def test_bulk_density():
    ...
    """
    print('='*60)
    print('TEST 6: OPC bulk water density (short NPT, ~20ps)')
    print('='*60)
...
def test_preset_parity():
    ...
    # Build both presets
    ff_fast = ForceField('amber14-all.xml', 'amber14/tip3p.xml')
    ff_accurate = ForceField('amber19/protein.ff19SB.xml', 'amber/opc_standard.xml')
...
def main():
    ...
    tests = [
        ...
        ('Geometry after minimization', test_water_geometry_after_minimization),
        ('Bulk water density', test_bulk_density),
